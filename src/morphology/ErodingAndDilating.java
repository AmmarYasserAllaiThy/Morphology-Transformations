...
public class ErodingAndDilating {
    ...
    private ErodingAndDilating() {
        ...
        if (matImgSrc.empty()) {
            ...
            System.exit(0);
        } else if (matImgSrc.height() > 600)
            matImgSrc = Imgcodecs.imread(Resizer.resize_then_save(
                    imagePath,
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(() -> new ErodingAndDilating());
    }
}
